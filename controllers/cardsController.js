...
class cardController{
    ...
    async trade(cardid1,userid1,cardid2,userid2){
        const t1=await pool.query('update usercards set userid=$1 where userid=$2 and cardid=$3 limit 1',[userid1,userid2,cardid2]);
        const t2=await pool.query('update usercards set userid=$1 where userid=$2 and cardid=$3 limit 1',[userid2,userid1,cardid1]);
